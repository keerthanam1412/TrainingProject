<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sigin.aspx.cs" Inherits="sigin" %>
    ...
    <div class="col-sm-6" style="background-color:white;text-align:center; padding-top: 15px;  height: 53px;">
     ...
     <div class="mx-auto col-md-3 col-4 bg-white p-5" >
          ...
          <form id="form2" runat="server">
            ...
            <div class="form-group"> <asp:TextBox id="TextBox2" runat="server" class="form-control" placeholder=" Enter New Password" TextMode="Password" /> </div>
              <small class="form-text text-muted text-right">
               
              </small>  <asp:Button id="Button1" runat="server" Text="Sign in" class="btn btn-primary" OnClick="Button1_Click"/>
