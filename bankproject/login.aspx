    ...
    <div class="col-sm-6" style="background-color:white;text-align:center; padding-top:15px; height: 53px;">
     ...
     <div class="mx-auto col-md-3 col-4 bg-white p-5" >
          ...
          <form id="form2" runat="server">
            ...
            <div class="form-group"> <asp:TextBox id="tbcustomer" runat="server" class="form-control" placeholder="Customer_id"/> </div>
            <div class="form-group mb-3"> <asp:TextBox id="tbpassword" runat="server" class="form-control" placeholder="Password" TextMode="Password" /> <small class="form-text text-muted text-right">
